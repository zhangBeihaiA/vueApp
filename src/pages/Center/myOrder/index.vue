    ...
    <div class="order-content">
      ...
      <div class="orders">
        ...
        <table class="order-item" v-for="order in myOrder.records" :key="order.id">
          ...
          <tbody>
            <tr v-for="cart in order.orderDetailList" :key="cart.id">
              <td width="60%">
              ...
              <td :rowspan="cart.length" width="8%" class="center">{{ order.consignee }}</td>
              <td :rowspan="cart.length" width="13%" class="center">
                <ul class="unstyled">
                  <li>总金额{{order.totalAmount}}</li>
                  <li>在线支付</li>
                </ul>
              </td>
              <td :rowspan="cart.length" width="8%" class="center">
