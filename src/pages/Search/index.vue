                ...
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a
                    >综合<span
                      v-if="isOne"
                      class="iconfont"
                      :class="{ 'icon-up_s': isAsc, 'icon-down_s': isDesc }"
                    ></span
                  ></a>
                </li>
                <!-- <li :class="{ active: isOne }"><a>综合<span v-if="isOne" class="iconfont" :class="{'isAsc' ? 'icon-up':'icon-down'}"></span>不对</a></li> -->
...
export default {
  ...
  //mapState函数返回的是一个对象， ...mapState() 解构赋值
  computed: {
    ...mapGetters({
      goodsList: "goodsList",
    }),
  ...
  methods: {
    ...
    trademarkInfo(t) {
      ...
      //  console.log(t.tmId,t.tmName)

      this.getData();
    },
    attrInfo(a2, a) {
      //a2:安卓手机， a.attrName：手机系统
      // console.log(a2,a)
    ...
    changeOrder(flag) {
      // let originOrder = this.serchParams.order
